...
let books = []; // <div class="p-4 hover:bg-surface-container-low transition-colors flex items-center justify-between group">
 ...
 //     </div>
 //     <div>
 //       <h4 class="font-headline-md text-body-lg text-primary leading-tight">Systems Thinking in Practice</h4>
 //       <p class="font-body-sm text-body-sm text-on-surface-variant">Dr. J. R. Sterling</p>
 //     </div>
 //   </div>
 //   <div class="flex items-center gap-6">
 //     <span
 //       class="px-3 py-1 bg-primary-container bg-opacity-20 text-primary-container rounded-full font-label-sm text-label-sm uppercase tracking-wider">Science</span>
...
//# sourceMappingURL=trabalho-final.34df32e0.js.map
